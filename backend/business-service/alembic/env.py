"""
Alembic environment. Uses the app's own async engine URL (via Settings) and
imports every module's ORM models so `alembic revision --autogenerate`
picks up the whole schema in one pass.
"""
