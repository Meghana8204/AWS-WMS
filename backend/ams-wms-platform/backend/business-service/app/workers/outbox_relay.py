...
delivery mechanism changes. Registered as an APScheduler interval job from app/main.py's lifespan.
"""
...
from app.kafka.producer import is_producer_active, publish
